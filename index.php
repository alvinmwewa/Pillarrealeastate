...
<!-- side_sticky_navbar -->
<div class="sidenav">
    <a href="#about"><span><i class="fa fa-facebook"></i></span></a>
    <a href="#services"><span><i class="fa fa-linkedin"></i></span></a>
    <a href="#services"><span><i class="fa fa-envelope"></i></span></a>
</div>
...
<!--                        <span class="menu-price">K3600</span>-->
<!--                    </div>-->
<!--                    <div class="media-body">-->
<!--                        <h3 class="media-heading">Low Cost</h3>-->
...
<!--                        <span class="menu-price">K24OO</span>-->
<!--                    </div>-->
<!--                    <div class="media-body">-->
<!--                        <h3 class="media-heading">Low Cost</h3>-->
<!--                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget diam et.</p>-->
...
<!--                        <span class="menu-price">K6400</span>-->
<!--                    </div>-->
<!--                    <div class="media-body">-->
<!--                        <h3 class="media-heading">High Cost</h3>-->
<!--                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget diam et.</p>-->
<!--                    </div>-->
<!--                </div>-->
<!---->
...
<!--                        <span class="menu-price">K4500</span>-->
<!--                    </div>-->
<!--                    <div class="media-body">-->
